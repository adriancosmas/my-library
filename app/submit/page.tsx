  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-2xl px-6 py-10">
        <h1 className="mb-2 text-2xl font-semibold dark:text-white text-neutral-900 font-sans">Submit Library</h1>
      ...
      <form action={createLibrary} className="space-y-4">
        ...
        <div className="grid gap-2">
          <label className="text-sm font-sans font-light">Logo URL</label>
          <input
            name="logo_url"
        ...
        <div className="grid gap-2">
          <label className="text-sm font-sans font-light">Tags</label>
          <AddTags />
        </div>
