    ...
    return(
        <>
            <Tags className="w-full">
                <TagsTrigger className="cursor-pointer dark:bg-transparent py-2 px-4 rounded-full bg-white text-base border border-black/10 dark:border-white/10 font-sans">
                    {selected.map((tag) => (
                ...
                <TagsContent>
                    ...
                    <TagsList>
                        <TagsEmpty>
                           <button
                                className="mx-auto flex cursor-pointer items-center gap-2 dark:bg-white/5 py-2 px-4 rounded-full bg-black/5 text-base font-sans"
