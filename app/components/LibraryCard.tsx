...
export default function LibraryCard({ lib }: { lib: Library }) {
  return (
    <a href={lib.website_url} target="_blank" rel="noreferrer" className="group flex flex-col gap-3 rounded-xl border dark:border-white/10 border-black/10 dark:bg-black/30 p-4 transition-colors dark:hover:border-white/30 dark:hover:bg-white/7 hover:bg-gray-100/50">
      ...
      <p className="line-clamp text-sm text-neutral-600 dark:text-zinc-300 flex-1 py-6">{lib.description}</p>
