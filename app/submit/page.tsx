  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-2xl px-6 py-10">
        <h1 className="mb-4 text-2xl font-semibold dark:text-white text-neutral-900">Submit Library</h1>
      {!isConfigured && (
      ...
      <form action={createLibrary} className="space-y-4">
        ...
        <button
            ...
            className="rounded-md dark:bg-yellow-200 bg-yellow-400 px-8 py-2 disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer text-neutral-900 font-semibold mt-4 text-base"
